#ifndef VARIATION_BOARD_CANVAS_H
#define VARIATION_BOARD_CANVAS_H
...
class VariationBoardCanvas: public wxScrolledWindow, public BaseVariationBoard
{
public:
    VariationBoardCanvas( MyFrame *parent, wxWindow *winParent );
	~VariationBoardCanvas();
...
private:
	...
	wxBitmap bmpBackToStart;
	wxBitmap bmpBack;
	wxBitmap bmpForward;
	wxBitmap bmpForwardToEnd;
